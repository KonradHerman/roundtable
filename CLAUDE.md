# CLAUDE.md - AI Assistant Guide for Cardless

> **Last Updated**: 2025-11-20
> **Status**: One Night Werewolf MVP in progress (Phase 2)
> **Live at**: [cardless.games](https://cardless.games)

This document provides AI assistants with essential context about the Cardless codebase, including architecture, conventions, and workflows.
...
│   └── tsconfig.json
│
└── [Documentation Files]         # 9 major .md files
